...
public record Cell(Specs northWall, Specs eastWall, Specs southWall, Specs westWall, Cell.Content initialContent) {
    ...
    public boolean murEnFaceDirection(Direction d){
        switch (d){
            case Direction.NORTH : return isnorthWall();
            case Direction.WEST : return iswestWall();
            case Direction.SOUTH : return issouthWall();
            case Direction.EAST : return iseastWall();
            default : return true;
        }
    }
